    ...
    <Fragment>
      <section>
        <button
          ...
          className="w-[260px] h-[72px] bg-[#000] flex justify-between absolute md:left-[40px]"
        >
      ...
      <section className="bg-[#000] px-[16px] box-border pt-[48px] md:flex md:px-[40px]">
        <h1 className="font-black text-[50px] mb-[48px] text-[#fff] md:text-[55px] md:mr-[75px]">
          OUR LOCATION
        </h1>
      ...
      <section className="bg-[#D5966C] text-[#000] box-border px-[32px] py-[48px] flex flex-col md:flex-row md:px-[40px] md:justify-between">
