  ...
  return (
    <div>
      <section className="mb-[120px] relative">
        ...
        <div className="flex flex-col px-[16px] md:w-[340px] md:absolute md:top-[145px] md:right-[40px]">
          <h1 className="font-black text-[60px] mb-[32px] leading-[55px] md:mb-[48px] ">
            MODERN ART GALLERY
          </h1>
          <p className="font-[outfit] text-[18px] mb-[32px]  md:mb-[48px]">
      ...
      <section className="flex flex-col px-[16px] md:flex-row-reverse md:px-[40px] md:justify-between">
        <picture>
          <source
            media="(min-width: 1400px)"
            srcSet={
      ...
      <section className="mb-[120px] md:px-[40px] md:flex">
        <picture>
          <source
            media="(min-width: 1400px)"
            srcSet={
        ...
        <div className="px-[16px]">
          ...
          <div className="bg-[#000] h-[293px] text-[#fff] px-[24px] py-[47px] box-border md:px-0 md:w-[280px] md:pl-[30px] md:h-[351px]">
            <h3 className="font-black text-[50px] leading-[45px] mb-[24px]">
              COME & BE INSPIRED
            </h3>
            <p className="font-[outfit] text-[18px] font-light">
      ...
      <section className="bg-[#000] text-white box-border px-[32px] py-[48px] flex flex-col md:flex-row md:px-[40px] md:justify-between">
        <img src={logoWhite} className="mb-[38px] h-[40px] w-[110px]" />
        <p className="font-[outfit] mb-[38px] leading-7 font-light md:w-[281px] md:mb-0">
